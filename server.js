...
function fetchUsers() {
    return __awaiter(this, arguments, void 0, function (count) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, node_fetch_1.default)("https://randomuser.me/api/?results=".concat(count))];
                case 1:
                    res = _a.sent();
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetchUsers(1000)];
            case 1:
                storeVar = _a.sent();
                return [2 /*return*/];
        }
...
app
    ...
    var results = parseInt(req.query.results) || 1;
    if (results === 1) {
